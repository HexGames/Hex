public static class Map
{
    ...
    public static void PopUpBenefit(Data.HexCoords coord, string text) => Instance?.PopUpBenefit(coord, text);
    public static void PlayTile(Data.Tile tile, Data.HexCoords hexCoord) => Instance?.OnPlayTile(tile, hexCoord);
