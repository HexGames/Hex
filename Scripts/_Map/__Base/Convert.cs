...
namespace Hex.GodotMap
{
    ...
    {
        internal static Vector3 HexPosToWorld(Data.HexPos coords)
        {
        ...
        internal static Hex.Data.HexPos WorldToHexPos(Vector3 position)
        {
            float x = position.X;
            float z = position.Z;
        ...
        internal static Vector2 WorldToScreen(Vector3 worldPos)
        {
            return MapBindings.X.MainViewport.GetCamera3D().UnprojectPosition(worldPos);
        }
    }
}
