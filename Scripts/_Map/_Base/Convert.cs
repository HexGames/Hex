...
namespace Godot3D
{
    ...
    {
        public static Vector3 HexCoordToWorld(Data.HexCoords coords)
        {
        ...
        public static Data.HexCoords WorldToHexCoord(Vector3 position)
        {
            float x = position.X;
            float z = position.Z;
            ...
            return new Data.HexCoords(rx, ry);
        }
